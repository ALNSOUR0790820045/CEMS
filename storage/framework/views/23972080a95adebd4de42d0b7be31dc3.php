...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="symbol" class="form-input" 
                           value="<?php echo e(old('symbol')); ?>" required 
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group">
                ...
                <input type="number" name="exchange_rate" class="form-input" 
                       value="<?php echo e(old('exchange_rate', '1.000000')); ?>" 
            ...
            <div class="form-group">
                <div class="checkbox-wrapper">
                    <input type="checkbox" name="is_base" id="is_base" 
                           value="1" <?php echo e(old('is_base') ? 'checked' : ''); ?>>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/CEMS/CEMS/resources/views/currencies/create.blade.php ENDPATH**/ ?>