...
<div style="padding: 40px; max-width: 1000px; margin: 0 auto;">
    <h1 style="margin-bottom: 30px;">تعديل العميل: <?php echo e($client->name); ?></h1>
    ...
    <form method="POST" action="<?php echo e(route('clients.update', $client)); ?>" style="background: white; padding: 30px; border-radius: 10px;">
        <?php echo csrf_field(); ?>
        ...
        <div class="tab-content active" data-tab="basic">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div style="grid-column: 1 / -1;">
                    ...
                    <input type="text" value="<?php echo e($client->client_code); ?>" readonly 
                ...
                <div>
                    ...
                    <input type="text" name="name_en" value="<?php echo e(old('name_en', $client->name_en)); ?>" 
                        style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                </div>
                ...
                <div>
                    ...
                    <select name="client_type" required 
                        ...
                        <option value="government" <?php echo e(old('client_type', $client->client_type) == 'government' ? 'selected' : ''); ?>>حكومي</option>
                        <option value="semi_government" <?php echo e(old('client_type', $client->client_type) == 'semi_government' ? 'selected' : ''); ?>>شبه حكومي</option>
                        <option value="private_sector" <?php echo e(old('client_type', $client->client_type) == 'private_sector' ? 'selected' : ''); ?>>قطاع خاص</option>
                ...
                <div>
                    ...
                    <select name="client_category" required 
                        ...
                        <option value="strategic" <?php echo e(old('client_category', $client->client_category) == 'strategic' ? 'selected' : ''); ?>>استراتيجي</option>
                        <option value="preferred" <?php echo e(old('client_category', $client->client_category) == 'preferred' ? 'selected' : ''); ?>>مفضل</option>
                        <option value="regular" <?php echo e(old('client_category', $client->client_category) == 'regular' ? 'selected' : ''); ?>>عادي</option>
                        <option value="one_time" <?php echo e(old('client_category', $client->client_category) == 'one_time' ? 'selected' : ''); ?>>لمرة واحدة</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <select name="rating" 
                        ...
                        <option value="excellent" <?php echo e(old('rating') == 'excellent' ? 'selected' : ''); ?>>ممتاز (⭐⭐⭐⭐⭐)</option>
                        <option value="good" <?php echo e(old('rating') == 'good' ? 'selected' : ''); ?>>جيد (⭐⭐⭐⭐)</option>
                        <option value="average" <?php echo e(old('rating') == 'average' ? 'selected' : ''); ?>>متوسط (⭐⭐⭐)</option>
                        <option value="poor" <?php echo e(old('rating') == 'poor' ? 'selected' : ''); ?>>ضعيف (⭐⭐)</option>
                    </select>
                </div>
        ...
        <div class="tab-content" data-tab="legal" style="display: none;">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div>
                    ...
                    <input type="text" name="commercial_registration" value="<?php echo e(old('commercial_registration')); ?>" 
                        style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                </div>
                
                <div>
                    <label style="display: block; margin-bottom: 5px; font-weight: 600;">الرقم الضريبي</label>
                    <input type="text" name="tax_number" value="<?php echo e(old('tax_number')); ?>" 
                        style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                </div>
        ...
        <div class="tab-content" data-tab="contact" style="display: none;">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div>
                    ...
                    <input type="text" name="country" value="<?php echo e(old('country', 'JO')); ?>" 
                        style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                </div>
                ...
                <div style="grid-column: 1 / -1;">
                    ...
                    <textarea name="address" rows="3" 
                        style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;"><?php echo e(old('address')); ?></textarea>
                </div>
                
                <div>
                    <label style="display: block; margin-bottom: 5px; font-weight: 600;">صندوق البريد</label>
                    <input type="text" name="po_box" value="<?php echo e(old('po_box')); ?>" 
                        style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                </div>
                ...
                <div style="grid-column: 1 / -1; margin-top: 20px; padding-top: 20px; border-top: 1px solid #f0f0f0;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                        <div>
                            ...
                            <input type="text" name="primary_contact_person" value="<?php echo e(old('primary_contact_person')); ?>" 
                                style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                        </div>
                        
                        <div>
                            <label style="display: block; margin-bottom: 5px; font-weight: 600;">المسمى الوظيفي</label>
                            <input type="text" name="primary_contact_title" value="<?php echo e(old('primary_contact_title')); ?>" 
                                style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                        </div>
                        
                        <div>
                            <label style="display: block; margin-bottom: 5px; font-weight: 600;">الهاتف</label>
                            <input type="text" name="primary_contact_phone" value="<?php echo e(old('primary_contact_phone')); ?>" 
                                style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                        </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div>
                    ...
                    <select name="payment_terms" required 
                        style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                        <option value="immediate" <?php echo e(old('payment_terms') == 'immediate' ? 'selected' : ''); ?>>فوري</option>
                        <option value="7_days" <?php echo e(old('payment_terms') == '7_days' ? 'selected' : ''); ?>>7 أيام</option>
                        <option value="15_days" <?php echo e(old('payment_terms') == '15_days' ? 'selected' : ''); ?>>15 يوم</option>
                        <option value="30_days" <?php echo e(old('payment_terms', '30_days') == '30_days' ? 'selected' : ''); ?>>30 يوم</option>
                        <option value="45_days" <?php echo e(old('payment_terms') == '45_days' ? 'selected' : ''); ?>>45 يوم</option>
                        <option value="60_days" <?php echo e(old('payment_terms') == '60_days' ? 'selected' : ''); ?>>60 يوم</option>
                        <option value="90_days" <?php echo e(old('payment_terms') == '90_days' ? 'selected' : ''); ?>>90 يوم</option>
                        <option value="custom" <?php echo e(old('payment_terms') == 'custom' ? 'selected' : ''); ?>>مخصص</option>
                    </select>
                </div>
                
                <div>
                    <label style="display: block; margin-bottom: 5px; font-weight: 600;">الحد الائتماني</label>
                    <input type="number" step="0.01" name="credit_limit" value="<?php echo e(old('credit_limit')); ?>" 
                        style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                </div>
                
                <div>
                    <label style="display: block; margin-bottom: 5px; font-weight: 600;">العملة</label>
                    <input type="text" name="currency" value="<?php echo e(old('currency', 'JOD')); ?>" 
                        style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                </div>
                
                <div>
                    <label style="display: block; margin-bottom: 5px; font-weight: 600;">حساب الذمم المدينة</label>
                    <input type="text" name="gl_account" value="<?php echo e(old('gl_account')); ?>" 
                        style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                </div>
                ...
                <div style="grid-column: 1 / -1;">
                    ...
                    <textarea name="notes" rows="4" 
                        style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;"><?php echo e(old('notes')); ?></textarea>
                </div>
            </div>
        </div>
        ...
        <div style="margin-top: 30px; padding-top: 20px; border-top: 1px solid #f0f0f0; display: flex; gap: 15px;">
            ...
            <a href="<?php echo e(route('clients.index')); ?>" style="padding: 12px 30px; text-decoration: none; color: #666; background: #f5f5f7; border-radius: 8px; font-family: 'Cairo', sans-serif; font-weight: 600;">
                إلغاء
            </a>
        </div>
    </form>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/CEMS/CEMS/resources/views/clients/edit.blade.php ENDPATH**/ ?>