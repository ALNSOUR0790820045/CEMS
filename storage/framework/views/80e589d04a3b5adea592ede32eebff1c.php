...
<div class="container">
    <div class="page-header">
        <div>
            <h1 class="page-title"><?php echo e($role->name); ?></h1>
            <div class="breadcrumb">
                <a href="<?php echo e(route('roles.index')); ?>">الأدوار</a>
                <span>/</span>
                <span>عرض</span>
            </div>
        </div>
    ...
    <div class="card">
        ...
        <div class="info-grid">
            <div class="info-item">
                ...
                <div class="info-value"><?php echo e($role->name); ?></div>
            </div>
            <div class="info-item">
            ...
            <div class="info-item">
                ...
                <div class="info-value">
                    <span class="badge badge-success">
                        <?php echo e($role->users->count()); ?> مستخدم
                    </span>
                </div>
            </div>
            <div class="info-item">
                <div class="info-label">تاريخ الإنشاء</div>
                <div class="info-value"><?php echo e($role->created_at->format('Y-m-d')); ?></div>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        ...
        <?php if($groupedPermissions->count() > 0): ?>
                ...
                <?php $__currentLoopData = $groupedPermissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $module => $permissions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="permission-module">
                        <div class="module-title">
                            <span class="module-count"><?php echo e(count($permissions)); ?></span>
                            <?php echo e($moduleNames[$module] ?? $module); ?>
                        ...
                        <div class="permission-list">
                            <?php $__currentLoopData = $permissions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $permission): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                    ...
                                    $action = end($parts);
                                ?>
                                <span class="permission-tag"><?php echo e($actionNames[$action] ?? $action); ?></span>
    ...
    <div class="card">
        <h2 class="card-title">
            ...
            المستخدمون (<?php echo e($role->users->count()); ?>)
        </h2>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/CEMS/CEMS/resources/views/roles/show.blade.php ENDPATH**/ ?>