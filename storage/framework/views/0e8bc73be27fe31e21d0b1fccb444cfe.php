...
<div style="padding: 40px; max-width: 1000px; margin: 0 auto;">
    <h1 style="margin-bottom: 30px;">إضافة عميل جديد</h1>
    ...
    <form method="POST" action="<?php echo e(route('clients.store')); ?>" style="background: white; padding: 30px; border-radius: 10px;">
        <?php echo csrf_field(); ?>
        ...
        <div class="tab-content active" data-tab="basic">
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                <div style="grid-column: 1 / -1;">
                    ...
                    <input type="text" value="<?php echo e($clientCode); ?>" readonly 
                ...
                <div>
                    ...
                    <select name="client_type" required 
                        ...
                        <option value="government" <?php echo e(old('client_type') == 'government' ? 'selected' : ''); ?>>حكومي</option>
                        <option value="semi_government" <?php echo e(old('client_type') == 'semi_government' ? 'selected' : ''); ?>>شبه حكومي</option>
                        <option value="private_sector" <?php echo e(old('client_type') == 'private_sector' ? 'selected' : ''); ?>>قطاع خاص</option>
                ...
                <div>
                    ...
                    <select name="client_category" required 
                        ...
                        <option value="strategic" <?php echo e(old('client_category') == 'strategic' ? 'selected' : ''); ?>>استراتيجي</option>
                        <option value="preferred" <?php echo e(old('client_category') == 'preferred' ? 'selected' : ''); ?>>مفضل</option>
                        <option value="regular" <?php echo e(old('client_category') == 'regular' ? 'selected' : ''); ?>>عادي</option>
                        <option value="one_time" <?php echo e(old('client_category') == 'one_time' ? 'selected' : ''); ?>>لمرة واحدة</option>
                    </select>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/CEMS/CEMS/resources/views/clients/create.blade.php ENDPATH**/ ?>