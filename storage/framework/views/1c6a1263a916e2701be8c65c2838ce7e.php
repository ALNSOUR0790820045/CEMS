...
<div style="padding: 40px; max-width: 1400px; margin: 0 auto;">
    <div class="page-header">
        ...
        <a href="<?php echo e(route('currencies.create')); ?>" class="btn-primary">
        ...
        <form method="GET" action="<?php echo e(route('currencies.index')); ?>">
            <div style="display: grid; grid-template-columns: 2fr 1fr auto; gap: 15px;">
                ...
                <select name="status" class="search-input">
                    ...
                    <option value="1" <?php echo e(request('status') === '1' ? 'selected' : ''); ?>>نشطة</option>
                    <option value="0" <?php echo e(request('status') === '0' ? 'selected' : ''); ?>>غير نشطة</option>
                </select>
            ...
            <tbody>
                <?php $__empty_1 = true; $__currentLoopData = $currencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $currency): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo e(route('currencies.edit', $currency)); ?>" class="btn-edit">تعديل</a>
                            <form method="POST" action="<?php echo e(route('currencies.destroy', $currency)); ?>" 
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/CEMS/CEMS/resources/views/currencies/index.blade.php ENDPATH**/ ?>