            ...
            <div class="nav-container">
                ...
                <div class="nav-group">
                    ...
                    <div class="mega-menu">
                        ...
                        <div class="menu-col">
                            <h4>المعدات</h4>
                            <a href="<?php echo e(route('equipment.index')); ?>" class="sub-link"><i data-lucide="truck"></i> الآليات</a>
                            <a href="<?php echo e(route('equipment.create')); ?>" class="sub-link"><i data-lucide="plus"></i> إضافة معدة</a>
                            <a href="<?php echo e(route('equipment.available')); ?>" class="sub-link"><i data-lucide="check-circle"></i> المعدات المتاحة</a>
                        </div>
                    </div>
                </div>
