                ...
                <div class="nav-group">
                    ...
                    <div class="mega-menu">
                        <div class="menu-col">
                            ...
                            <a href="<?php echo e(route('companies.index')); ?>" class="sub-link"><i data-lucide="building-2"></i> إدارة الشركات</a>
                            <a href="<?php echo e(route('branches.index')); ?>" class="sub-link"><i data-lucide="map"></i> الفروع</a>
                        </div>
                        <div class="menu-col">
                            <h4>العمليات</h4>
