                ...
                <div class="nav-group">
                    ...
                    <div class="mega-menu">
                        ...
                        <div class="menu-col">
                            ...
                            <a href="<?php echo e(route('units.index')); ?>" class="sub-link"><i data-lucide="ruler"></i> وحدات القياس</a>
                            <a href="<?php echo e(route('companies.index')); ?>" class="sub-link"><i data-lucide="building-2"></i> الشركات</a>
