...
<div style="padding: 40px; max-width: 800px; margin: 0 auto;">
    ...
    <form method="POST" action="<?php echo e(route('cities.update', $city)); ?>" style="background: white; padding: 30px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        <?php echo csrf_field(); ?>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="name" value="<?php echo e(old('name', $city->name)); ?>" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
        </div>
        
        <div style="margin-bottom: 20px;">
            <label style="display: block; margin-bottom: 5px; font-weight: 600;">اسم المدينة (بالإنجليزية)</label>
            <input type="text" name="name_en" value="<?php echo e(old('name_en', $city->name_en)); ?>" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/CEMS/CEMS/resources/views/cities/edit.blade.php ENDPATH**/ ?>