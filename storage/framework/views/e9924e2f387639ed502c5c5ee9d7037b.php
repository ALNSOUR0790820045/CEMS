...
<form method="POST" action="<?php echo e(route('purchase-orders.store')); ?>" id="purchaseOrderForm">
    <?php echo csrf_field(); ?>
    ...
    <div class="form-card">
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                ...
                <input type="date" name="order_date" class="form-control" value="<?php echo e(old('order_date', date('Y-m-d'))); ?>" required>
            </div>

            <div class="form-group">
                <label>التاريخ المتوقع للاستلام</label>
                <input type="date" name="expected_date" class="form-control" value="<?php echo e(old('expected_date')); ?>">
            </div>
            ...
            <div class="form-group">
                ...
                <select name="payment_term_id" class="form-select" required>
                    ...
                    <?php $__currentLoopData = $paymentTerms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $term): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($term->id); ?>" <?php echo e(old('payment_term_id') == $term->id ? 'selected' : ''); ?>>
                            <?php echo e($term->name); ?> (<?php echo e($term->days); ?> يوم)
                        </option>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" step="0.01" name="discount" class="form-control" value="<?php echo e(old('discount', 0)); ?>" id="orderDiscount">
            </div>
        </div>
    ...
    <div class="form-actions">
        <a href="<?php echo e(route('purchase-orders.index')); ?>" class="btn-secondary">
            <i data-lucide="x"></i>
            إلغاء
        </a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/CEMS/CEMS/resources/views/purchase-orders/create.blade.php ENDPATH**/ ?>