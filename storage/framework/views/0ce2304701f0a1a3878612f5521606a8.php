...
<div class="jea-header">
    ...
    <p class="jea-subtitle"><?php echo e($template->name_en ?? 'JEA-01 Contract Template'); ?></p>
</div>
...
<div class="features-section">
    ...
    <div style="display: flex; gap: 12px; flex-wrap: wrap;">
        <a href="<?php echo e(route('contract-templates.show', $template->id)); ?>" style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 20px; background: rgba(0, 113, 227, 0.1); color: var(--accent); border-radius: 8px; text-decoration: none; font-weight: 600; transition: all 0.2s;">
            <i data-lucide="eye" style="width: 18px; height: 18px;"></i>
            عرض تفاصيل العقد
        </a>
        <a href="<?php echo e(route('contract-templates.clauses', $template->id)); ?>" style="display: inline-flex; align-items: center; gap: 8px; padding: 12px 20px; background: rgba(0, 113, 227, 0.1); color: var(--accent); border-radius: 8px; text-decoration: none; font-weight: 600; transition: all 0.2s;">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/CEMS/CEMS/resources/views/contract-templates/jea-01.blade.php ENDPATH**/ ?>