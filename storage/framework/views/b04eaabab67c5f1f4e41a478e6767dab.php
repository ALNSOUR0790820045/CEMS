...
<div style="max-width: 1600px; margin: 0 auto;">
    ...
    <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px; margin-bottom: 30px;">
        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 25px; border-radius: 12px; color: white; box-shadow: 0 4px 12px rgba(102, 126, 234, 0.3);">
            ...
            <div style="font-size: 2.2rem; font-weight: 700; margin-bottom: 5px;"><?php echo e($statistics['total_count']); ?></div>
            <div style="font-size: 0.9rem; opacity: 0.8;"><?php echo e(number_format($statistics['total_value'], 2)); ?> ر.س</div>
        </div>
        ...
        <div style="background: linear-gradient(135deg, #f093fb 0%, #f5576c 100%); padding: 25px; border-radius: 12px; color: white; box-shadow: 0 4px 12px rgba(240, 147, 251, 0.3);">
            ...
            <div style="font-size: 2.2rem; font-weight: 700; margin-bottom: 5px;"><?php echo e($statistics['pending_count']); ?></div>
            <div style="font-size: 0.9rem; opacity: 0.8;"><?php echo e(number_format($statistics['pending_value'], 2)); ?> ر.س</div>
        </div>
        ...
        <div style="background: linear-gradient(135deg, #4facfe 0%, #00f2fe 100%); padding: 25px; border-radius: 12px; color: white; box-shadow: 0 4px 12px rgba(79, 172, 254, 0.3);">
            ...
            <div style="font-size: 2.2rem; font-weight: 700; margin-bottom: 5px;"><?php echo e($statistics['approved_count']); ?></div>
            <div style="font-size: 0.9rem; opacity: 0.8;"><?php echo e(number_format($statistics['approved_value'], 2)); ?> ر.س</div>
        </div>
        ...
        <div style="background: linear-gradient(135deg, #43e97b 0%, #38f9d7 100%); padding: 25px; border-radius: 12px; color: white; box-shadow: 0 4px 12px rgba(67, 233, 123, 0.3);">
            ...
            <div style="font-size: 2.2rem; font-weight: 700; margin-bottom: 5px;"><?php echo e($statistics['paid_count']); ?></div>
            <div style="font-size: 0.9rem; opacity: 0.8;"><?php echo e(number_format($statistics['paid_value'], 2)); ?> ر.س</div>
        </div>
        ...
        <div style="background: linear-gradient(135deg, #fa709a 0%, #fee140 100%); padding: 25px; border-radius: 12px; color: white; box-shadow: 0 4px 12px rgba(250, 112, 154, 0.3);">
            ...
            <div style="font-size: 2.2rem; font-weight: 700; margin-bottom: 5px;"><?php echo e(number_format($statistics['retention_total'], 0)); ?></div>
        ...
        <div style="background: linear-gradient(135deg, #a8edea 0%, #fed6e3 100%); padding: 25px; border-radius: 12px; color: #1d1d1f; box-shadow: 0 4px 12px rgba(168, 237, 234, 0.3);">
            ...
            <div style="font-size: 2.2rem; font-weight: 700; margin-bottom: 5px;">
                <?php echo e($avgConsultantDays || $avgClientDays ? number_format((($avgConsultantDays ?? 0) + ($avgClientDays ?? 0)) / (($avgConsultantDays ? 1 : 0) + ($avgClientDays ? 1 : 0)), 1) : '0.0'); ?>
            ...
            <div style="display: grid; gap: 15px;">
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 15px; background: #f5f5f7; border-radius: 8px;">
                    ...
                    <div style="font-size: 1.8rem; font-weight: 700; color: var(--accent);">
                        <?php echo e(number_format($avgConsultantDays, 1)); ?> يوم
                    </div>
                </div>
                ...
                <div style="display: flex; justify-content: space-between; align-items: center; padding: 15px; background: #f5f5f7; border-radius: 8px;">
                    ...
                    <div style="font-size: 1.8rem; font-weight: 700; color: var(--accent);">
                        <?php echo e(number_format($avgClientDays, 1)); ?> يوم
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="background: white; padding: 25px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
            ...
            <div style="height: 200px; display: flex; align-items: end; gap: 10px; padding: 20px 0;">
                ...
                <div style="flex: 1; display: flex; flex-direction: column; align-items: center; gap: 10px;">
                    <div style="width: 100%; height: <?php echo e(($statistics['total_value'] / $maxValue) * 100); ?>%; background: linear-gradient(180deg, #667eea, #764ba2); border-radius: 8px 8px 0 0; min-height: 30px; display: flex; align-items: center; justify-content: center; color: white; font-size: 0.8rem; font-weight: 600;"></div>
                    <div style="font-size: 0.75rem; font-weight: 600; text-align: center;">إجمالي</div>
                </div>
                <div style="flex: 1; display: flex; flex-direction: column; align-items: center; gap: 10px;">
                    <div style="width: 100%; height: <?php echo e(($statistics['paid_value'] / $maxValue) * 100); ?>%; background: linear-gradient(180deg, #43e97b, #38f9d7); border-radius: 8px 8px 0 0; min-height: 30px;"></div>
                    <div style="font-size: 0.75rem; font-weight: 600; text-align: center;">مدفوع</div>
                </div>
                <div style="flex: 1; display: flex; flex-direction: column; align-items: center; gap: 10px;">
                    <div style="width: 100%; height: <?php echo e(($statistics['retention_total'] / $maxValue) * 100); ?>%; background: linear-gradient(180deg, #fa709a, #fee140); border-radius: 8px 8px 0 0; min-height: 30px;"></div>
    ...
    <div style="background: white; border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        ...
        <div style="overflow-x: auto;">
            <table style="width: 100%; border-collapse: collapse; font-size: 0.85rem;">
                ...
                <tbody>
                    <?php $__currentLoopData = $ipcs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ipc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr style="border-bottom: 1px solid #e5e5e7;">
                            <td style="padding: 10px; border: 1px solid #e5e5e7;">
                                <a href="<?php echo e(route('main-ipcs.show', $ipc)); ?>" style="color: var(--accent); font-weight: 600; text-decoration: none;">
                                    <?php echo e($ipc->ipc_number); ?>

                                </a>
                            </td>
                            <td style="padding: 10px; border: 1px solid #e5e5e7;"><?php echo e($ipc->project->name); ?></td>
                            <td style="padding: 10px; border: 1px solid #e5e5e7;"><?php echo e($ipc->submission_date->format('Y/m/d')); ?></td>
                            <td style="padding: 10px; border: 1px solid #e5e5e7; font-weight: 600;"><?php echo e(number_format($ipc->current_cumulative, 2)); ?></td>
                            <td style="padding: 10px; border: 1px solid #e5e5e7; color: #ff9500;"><?php echo e(number_format($ipc->retention_amount, 2)); ?></td>
                            <td style="padding: 10px; border: 1px solid #e5e5e7; font-weight: 700; color: #34c759;"><?php echo e(number_format($ipc->net_payable, 2)); ?></td>
                            <td style="padding: 10px; border: 1px solid #e5e5e7;">
                                <span style="padding: 4px 10px; border-radius: 6px; font-size: 0.75rem; font-weight: 600;
                                    background: rgba(<?php echo e($ipc->status_badge['color'] === 'green' ? '52, 199, 89' : ($ipc->status_badge['color'] === 'blue' ? '0, 113, 227' : ($ipc->status_badge['color'] === 'yellow' ? '255, 204, 0' : '134, 134, 139'))); ?>, 0.1);
                                    color: <?php echo e($ipc->status_badge['color'] === 'green' ? '#34c759' : ($ipc->status_badge['color'] === 'blue' ? '#0071e3' : ($ipc->status_badge['color'] === 'yellow' ? '#ffcc00' : '#86868b'))); ?>;">
                                    <?php echo e($ipc->status_badge['label']); ?>

                                </span>
                            </td>
                            <td style="padding: 10px; border: 1px solid #e5e5e7;">
                                <?php if($ipc->consultant_review_days): ?>
                                    استشاري: <?php echo e($ipc->consultant_review_days); ?> يوم<br>
                                <?php endif; ?>
                                <?php if($ipc->client_review_days): ?>
                                    عميل: <?php echo e($ipc->client_review_days); ?> يوم
                                <?php endif; ?>
                                <?php if(!$ipc->consultant_review_days && !$ipc->client_review_days): ?>
                ...
                <tfoot>
                    <tr style="background: #f5f5f7; font-weight: 700;">
                        ...
                        <td style="padding: 12px; border: 1px solid #e5e5e7;"><?php echo e(number_format($ipcs->sum('current_cumulative'), 2)); ?></td>
                        <td style="padding: 12px; border: 1px solid #e5e5e7;"><?php echo e(number_format($ipcs->sum('retention_amount'), 2)); ?></td>
                        <td style="padding: 12px; border: 1px solid #e5e5e7; color: #34c759;"><?php echo e(number_format($ipcs->sum('net_payable'), 2)); ?></td>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/runner/work/CEMS/CEMS/resources/views/main-ipcs/report.blade.php ENDPATH**/ ?>