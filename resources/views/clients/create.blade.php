            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px;">
                ...
                <div>
                    ...
                    <select name="client_category" required 
                        ...
                        <option value="strategic" {{ old('client_category') == 'strategic' ? 'selected' : '' }}>استراتيجي</option>
                        <option value="preferred" {{ old('client_category') == 'preferred' ? 'selected' : '' }}>مفضل</option>
                        <option value="regular" {{ old('client_category') == 'regular' ? 'selected' : '' }}>عادي</option>
                        <option value="one_time" {{ old('client_category') == 'one_time' ? 'selected' : '' }}>لمرة واحدة</option>
                    </select>
                </div>
