...
<div style="max-width: 1200px; margin: 0 auto;">
    ...
    <form id="ipcForm" method="POST" action="{{ route('main-ipcs.store') }}" style="background: white; padding: 30px; border-radius: 12px; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
        @csrf
        ...
        <div style="margin-bottom: 40px;">
            ...
            <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 20px;">
                ...
                <div>
                    ...
                    <input type="date" name="submission_date" value="{{ date('Y-m-d') }}" required style="width: 100%; padding: 12px; border: 1px solid #ddd; border-radius: 8px; font-family: 'Cairo', sans-serif;">
                </div>
            </div>
        </div>
        ...
        <div style="display: flex; gap: 15px; justify-content: flex-end;">
            <a href="{{ route('main-ipcs.index') }}" style="padding: 12px 30px; background: #f5f5f7; color: #1d1d1f; border-radius: 8px; text-decoration: none; font-weight: 600;">
                إلغاء
            </a>
