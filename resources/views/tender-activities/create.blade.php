...
<div class="page-header">
    <h1 class="page-title">إضافة نشاط جديد</h1>
</div>

<div class="card">
    <form method="POST" action="{{ route('tender-activities.store', $tender) }}">
        @csrf
        
        <div class="form-row">
            <div class="form-group">
                <label class="form-label">رمز النشاط <span style="color: red;">*</span></label>
                <input type="text" name="activity_code" class="form-control" value="{{ old('activity_code', $activityCode) }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="tender_wbs_id" class="form-control">
                    ...
                    @foreach($wbsItems as $wbs)
                        <option value="{{ $wbs->id }}" {{ old('tender_wbs_id') == $wbs->id ? 'selected' : '' }}>
