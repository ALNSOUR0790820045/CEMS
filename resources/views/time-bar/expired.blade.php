...
<div style="padding: 40px;">
    <div style="max-width: 1400px; margin: 0 auto;">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 30px;">
            <div>
                <h1 style="font-size: 2rem; font-weight: 700; margin-bottom: 5px; color: #ff3b30;">أحداث منتهية (سقط الحق)</h1>
                <p style="color: #86868b;">الأحداث التي انتهى موعد الإشعار الخاص بها</p>
            </div>
