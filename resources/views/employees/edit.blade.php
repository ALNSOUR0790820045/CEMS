...
<div style="padding: 40px; max-width: 1000px; margin: 0 auto;">
    <h1 style="margin-bottom: 30px; font-size: 2rem; font-weight: 700;">تعديل بيانات الموظف</h1>
    
    <form method="POST" action="{{ route('employees.update', $employee) }}" enctype="multipart/form-data" style="background: white; padding: 30px; border-radius: 10px;">
        @csrf
        @method('PUT')
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" value="{{ $employee->employee_code }}" readonly style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; background: #f8f9fa; font-family: 'Cairo', sans-serif;">
        </div>

        <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 15px; margin-bottom: 20px;">
            <div>
                <label style="display: block; margin-bottom: 5px; font-weight: 600;">الاسم الأول *</label>
                <input type="text" name="first_name" required value="{{ old('first_name', $employee->first_name) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
            ...
            <div>
                ...
                <input type="text" name="middle_name" value="{{ old('middle_name', $employee->middle_name) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
            </div>
            <div>
                <label style="display: block; margin-bottom: 5px; font-weight: 600;">الاسم الأخير *</label>
                <input type="text" name="last_name" required value="{{ old('last_name', $employee->last_name) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
            <div>
                ...
                <input type="text" name="national_id" value="{{ old('national_id', $employee->national_id) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
            ...
            <div>
                ...
                <input type="text" name="passport_number" value="{{ old('passport_number', $employee->passport_number) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
            ...
            <div>
                ...
                <input type="date" name="date_of_birth" value="{{ old('date_of_birth', $employee->date_of_birth?->format('Y-m-d')) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
            <div>
                ...
                <input type="text" name="mobile" required value="{{ old('mobile', $employee->mobile) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
            ...
            <div>
                ...
                <input type="email" name="email" value="{{ old('email', $employee->email) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="job_title" required value="{{ old('job_title', $employee->job_title) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
            <div>
                ...
                <select name="employee_type" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                    <option value="permanent" {{ old('employee_type', $employee->employee_type) == 'permanent' ? 'selected' : '' }}>دائم</option>
                    <option value="contract" {{ old('employee_type', $employee->employee_type) == 'contract' ? 'selected' : '' }}>عقد</option>
                    <option value="temporary" {{ old('employee_type', $employee->employee_type) == 'temporary' ? 'selected' : '' }}>مؤقت</option>
                    <option value="consultant" {{ old('employee_type', $employee->employee_type) == 'consultant' ? 'selected' : '' }}>استشاري</option>
                    <option value="daily_worker" {{ old('employee_type', $employee->employee_type) == 'daily_worker' ? 'selected' : '' }}>عامل يومي</option>
                </select>
            </div>
            <div>
                <label style="display: block; margin-bottom: 5px; font-weight: 600;">تاريخ التوظيف *</label>
                <input type="date" name="hire_date" required value="{{ old('hire_date', $employee->hire_date->format('Y-m-d')) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
        ...
        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px; margin-bottom: 20px;">
            <div>
                ...
                <input type="number" step="0.01" name="basic_salary" value="{{ old('basic_salary', $employee->basic_salary) }}" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
            </div>
            <div>
                ...
                <select name="currency_id" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                    ...
                    @foreach($currencies as $currency)
                        <option value="{{ $currency->id }}" {{ old('currency_id', $employee->currency_id) == $currency->id ? 'selected' : '' }}>{{ $currency->name }} ({{ $currency->code }})</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div style="margin-top: 30px;">
            ...
            <a href="{{ route('employees.show', $employee) }}" style="margin-right: 15px; padding: 12px 30px; text-decoration: none; color: #666;">إلغاء</a>
        </div>
    </form>
</div>
@endsection
