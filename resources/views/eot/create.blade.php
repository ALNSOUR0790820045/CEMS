...
<div class="eot-create">
    <div class="page-header">
        <h1>إنشاء مطالبة EOT جديدة</h1>
        <p style="color: #86868b; margin: 0;">مطالبة تمديد الوقت وتكاليف الإطالة</p>
    </div>
    ...
    <div class="form-container">
        ...
        <form method="POST" action="{{ route('eot.store') }}">
            @csrf
                ...
                <div class="form-group">
                    ...
                    <select name="time_bar_claim_id" class="form-control">
                        ...
                        @foreach($timeBarClaims as $timeBarClaim)
                            <option value="{{ $timeBarClaim->id }}" {{ old('time_bar_claim_id') == $timeBarClaim->id ? 'selected' : '' }}>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <select name="cause_category" class="form-control" required>
                        ...
                        <option value="client_delay">تأخير المالك (FIDIC 8.4)</option>
                        <option value="consultant_delay">تأخير الاستشاري</option>
                        <option value="variations">أوامر تغييرية (FIDIC 13)</option>
                        <option value="unforeseeable_conditions">ظروف مادية غير منظورة (FIDIC 4.12)</option>
                        <option value="force_majeure">قوة قاهرة (FIDIC 19)</option>
                        <option value="weather">طقس استثنائي</option>
                        <option value="delays_by_others">تأخير الآخرين</option>
                        <option value="suspension">إيقاف الأعمال (FIDIC 8.8)</option>
                        <option value="late_drawings">تأخر المخططات</option>
                        <option value="late_approvals">تأخر الموافقات</option>
            ...
            <div class="form-row-3">
                <div class="form-group">
                    ...
                    <input type="date" name="event_start_date" class="form-control" value="{{ old('event_start_date') }}" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="event_duration_days" class="form-control" value="{{ old('event_duration_days') }}" min="1" required>
                </div>
            </div>

            <div class="form-group">
                <label>المادة القانونية (FIDIC)</label>
                <input type="text" name="fidic_clause_reference" class="form-control" value="{{ old('fidic_clause_reference') }}" placeholder="مثال: FIDIC 8.4">
            ...
            <div class="form-group">
                ...
                <textarea name="impact_description" class="form-control" required>{{ old('impact_description') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea name="justification" class="form-control" required>{{ old('justification') }}</textarea>
            ...
            <div class="form-row">
                <div class="form-group">
                    ...
                    <input type="number" name="requested_days" class="form-control" value="{{ old('requested_days') }}" min="1" required>
                </div>

                <div class="form-group">
                    <label>
                        <input type="checkbox" name="affects_critical_path" value="1" {{ old('affects_critical_path') ? 'checked' : '' }}>
            ...
            <div class="form-actions">
                <a href="{{ route('eot.index') }}" class="btn-secondary">إلغاء</a>
