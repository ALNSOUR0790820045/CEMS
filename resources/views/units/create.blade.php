...
<div style="padding: 40px; max-width: 800px; margin: 0 auto;">
    ...
    <form method="POST" action="{{ route('units.store') }}" style="background: white; padding: 30px; border-radius: 10px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
        @csrf
        ...
        <div style="margin-bottom: 20px;">
            ...
            <input type="text" name="code" value="{{ old('code') }}" required placeholder="مثال: KG, M, L" style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
        ...
        <div style="margin-bottom: 20px;">
            ...
            <select name="type" required style="width: 100%; padding: 10px; border: 1px solid #ddd; border-radius: 5px; font-family: 'Cairo', sans-serif;">
                ...
                <option value="quantity" {{ old('type') == 'quantity' ? 'selected' : '' }}>كمية</option>
            </select>
        </div>
